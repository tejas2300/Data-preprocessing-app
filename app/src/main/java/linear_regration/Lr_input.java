...
public class Lr_input extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lr_input);


        recyclerView = (RecyclerView) findViewById(R.id.rv);
        btn = (Button) findViewById(R.id.lr_input_btn);
        srno=findViewById(R.id.textViewsr1);
        textViewat1=findViewById(R.id.atbt1);
        textViewat2=findViewById(R.id.atbt2);
        final int k1= getIntent().getIntExtra("nlr1",0);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Lr_input.this, Lr_AnswerTable.class);
                ...
                if (TextUtils.isEmpty(atr1) || TextUtils.isEmpty(atr2)) {
                    Toast.makeText(Lr_input.this, "Please enter all attributes ", Toast.LENGTH_SHORT).show();
                }
                else {
                    intent.putExtra("atrlrans1", atr1);
                    intent.putExtra("atrlrans2", atr2);
